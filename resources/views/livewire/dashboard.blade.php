            ...
            <div class="bg-gray-100 dark:bg-neutral-900 overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Roles
                                </dt>
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['roles'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['cars'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-100 dark:bg-neutral-900 overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Brands</dt>
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['brands'] }}
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                @can('car.create')
                    <a href="{{ route('car.index') }}"
                        class="bg-green-500 hover:bg-green-600 dark:bg-green-700 dark:hover:bg-green-800 text-white px-4 py-2 rounded text-center block">
                        Manage Cars
                    </a>
                @endcan
